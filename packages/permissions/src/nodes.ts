...
export const PERMISSION_GROUPS: Record<string, readonly PermissionNode[]> = {
  ...
  Moderator: [
    'discord.moderation.view', 'discord.moderation.warn', 'discord.moderation.note',
    'discord.moderation.timeout', 'discord.moderation.kick', 'discord.moderation.clear',
    'discord.tickets.view',
  'discord.tickets.manage', 'roblox.view', 'roblox.moderation.kick',
  ],
  Administrator: [
    'discord.moderation.view', 'discord.moderation.warn', 'discord.moderation.note',
    'discord.moderation.timeout', 'discord.moderation.kick', 'discord.moderation.ban',
    'discord.moderation.unban', 'discord.moderation.clear', 'discord.moderation.channel',
    'discord.moderation.role', 'discord.moderation.nick', 'discord.security.view',
    'discord.security.manage', 'discord.security.lockdown', 'discord.tickets.manage',
    'discord.giveaways.manage', 'discord.levels.manage', 'discord.economy.manage',
    'discord.community.manage', 'discord.backup.create', 'discord.automation.manage',
    'dashboard.access', 'dashboard.analytics.view', 'roblox.view', 'roblox.moderation.kick',
    'roblox.moderation.ban', 'roblox.server.announce',
  ],
};
